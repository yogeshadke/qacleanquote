...
public class Read_Configration_From_config_Prop_Folder {
	...
	String path = "/Users/yogeshadke/Downloads/PR-ROKFS-main/src/main/java/rok/qa/Utilities/Read_Configration_From_config_Prop_Folder.java";
	...
	{
		String SFURL =properties.getProperty("SFURL");
		if(SFURL!=null)
			return SFURL;
		else
			throw new RuntimeException("Invalid SFURL");
			}
